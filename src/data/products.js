export const datasets = {
  ...
  Sweet: [
    ...
    { name: 'Caramel Candy', price: 3.79, description: 'Soft caramel candies.', image: 'https://img.freepik.com/free-photo/close-up-assorted-candy_91014-214.jpg', rating: 5, freshness: 'fresh' },
    { name: 'Fruit Jellies', price: 2.99, description: 'Colorful fruit jellies.', image: 'https://images.unsplash.com/photo-1525385133512-2f3bdd039054?q=80&w=1400&auto=format&fit=crop', rating: 4, freshness: 'fresh' },
    { name: 'Chocolate Cookies', price: 4.49, description: 'Crunchy chocolate chip cookies.', image: 'https://images.unsplash.com/photo-1519864600265-abb24223b477?q=80&w=1400&auto=format&fit=crop', rating: 4, freshness: 'fresh' },
    { name: 'Blueberry Muffins', price: 5.89, description: 'Baked muffins with blueberries.', image: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=1400&auto=format&fit=crop', rating: 4, freshness: 'fresh' },
    { name: 'Cream Rolls', price: 3.99, description: 'Rolls filled with sweet cream.', image: 'https://images.unsplash.com/photo-1519864600265-abb24223b477?q=80&w=1400&auto=format&fit=crop', rating: 5, freshness: 'fresh' },
    { name: 'Strawberry Cupcakes', price: 4.29, description: 'Cupcakes with strawberry topping.', image: 'https://images.unsplash.com/photo-1499636136210-6f4ee915583e?q=80&w=1400&auto=format&fit=crop', rating: 5, freshness: 'fresh' },
    { name: 'Chocolate Donut', price: 5.49, description: 'Donut topped with chocolate.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9VJKN_29evS_kUeqMkbMQMCQ933hrcKpYVA&s', rating: 5, freshness: 'fresh' },
    { name: 'Berry Tart', price: 6.79, description: 'Tart loaded with berries.', image: 'https://images.unsplash.com/photo-1490474418585-ba9bad8fd0ea?q=80&w=1400&auto=format&fit=crop', rating: 4, freshness: 'fresh' },
    ...
    { name: 'Jam Biscuits', price: 3.99, description: 'Biscuits filled with sweet jam.', image: 'https://www.mjwebs.in/wp-content/uploads/2018/07/Fruit-Jam-Biscuits.jpg', rating: 5, freshness: 'fresh' },
